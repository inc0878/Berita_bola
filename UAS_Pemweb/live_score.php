...
// Fungsi untuk mengelompokkan pertandingan berdasarkan tanggal
...
$groupedMatches = groupMatchesByDate($matches);
...
// Inisialisasi variabel untuk menyimpan data berita
$news = [];
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <table class="table table-striped">
                    <thead class="table-dark">
                        <tr>
                            <th colspan="5"><?php echo date('d-m-Y', strtotime($date)); ?></th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($matches as $match): ?>
                            <tr>
                                <td><?php echo $match['home_team']; ?> </span></td>
                                <td><span class="ms-5"><?php echo $match['home_score']; ?> vs <span class="me-5"><?php echo $match['away_score']; ?></span></td>
            ...
            <div class="col-md-4">
                ...
                <h2><u>HIGHLIGHT</u></h2>
                <?php
                // Batasi berita yang ditampilkan hanya 3 item
